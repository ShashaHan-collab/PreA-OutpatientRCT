...
# PreAOutpatientRCT
This repository contains the code classification analysis and data visualization for the paper: Tao, X., Zhou, S., Ding, K. et al. An LLM chatbot to facilitate primary-to-specialist care transitions: a randomized controlled trial. Nature Medicine. Published online January 19th (2026). 

Behind the paper: Why building AI for healthcare requires stakeholders, not just a dataset. https://communities.springernature.com/manage/posts/301897
