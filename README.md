...
# PreAOutpatientRCT
This repository contains the code classification analysis and data visualization for the paper: Tao, X., Zhou, S., Ding, K. et al. An LLM chatbot to facilitate primary-to-specialist care transitions: a randomized controlled trial. Nat Med (2026). https://doi.org/10.1038/s41591-025-04176-7


Behind the paper: Why building AI for healthcare requires stakeholders, not just a dataset. https://communities.springernature.com/posts/301897
